...
def upgrade() -> None:
    ...
    amendment_status_enum = postgresql.ENUM(
        "PENDING", "APPROVED", "REJECTED", name="amendment_status_enum"
    )
    ...
    op.create_index(
        op.f("ix_sacramental_amendments_id"), "sacramental_amendments", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_sacramental_amendments_record_id"),
        "sacramental_amendments",
        ["record_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_sacramental_amendments_is_deleted"),
        "sacramental_amendments",
        ["is_deleted"],
        unique=False,
    )
