...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        "documents_archdiocese_id_fkey", "documents", "archdioceses", ["archdiocese_id"], ["id"]
    )
    op.create_foreign_key(
        "documents_deanery_id_fkey", "documents", "deaneries", ["deanery_id"], ["id"]
    )
    op.create_foreign_key(
        "documents_parish_id_fkey", "documents", "parishes", ["parish_id"], ["id"]
    )
    op.create_foreign_key(
        "documents_commission_id_fkey", "documents", "commissions", ["commission_id"], ["id"]
    )
    op.create_foreign_key(
        "documents_council_id_fkey", "documents", "councils", ["council_id"], ["id"]
    )
    op.create_foreign_key(
        "documents_meeting_id_fkey", "documents", "meetings", ["meeting_id"], ["id"]
    )
    op.create_foreign_key("documents_priest_id_fkey", "documents", "priests", ["priest_id"], ["id"])
    op.create_foreign_key(
        "documents_parcel_id_fkey", "documents", "land_parcels", ["parcel_id"], ["id"]
    )
    ...
    # --------------------------------------------------------------------
    op.create_foreign_key(
        "surveys_archdiocese_id_fkey", "surveys", "archdioceses", ["archdiocese_id"], ["id"]
    )
    ...
    op.create_foreign_key(
        "survey_responses_respondent_parish_id_fkey",
        "survey_responses",
        "parishes",
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        "survey_responses_respondent_parish_id_fkey", "survey_responses", type_="foreignkey"
    )
